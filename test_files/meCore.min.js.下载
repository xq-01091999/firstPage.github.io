MeControlDefine("meCore",["exports","@mecontrol/web-inline","@mecontrol/web-boot"],function(t,f,h){"use strict";var r=function(t,e){return(r=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n])})(t,e)};function e(t,e){function n(){this.constructor=t}r(t,e),t.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)}var d=function(){return(d=Object.assign||function(t){for(var e,n=1,r=arguments.length;n<r;n++)for(var o in e=arguments[n])Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t}).apply(this,arguments)},s=function(){},i={},u=[],l=[];function v(t,e){var n,r,o,i,a=l;for(i=arguments.length;2<i--;)u.push(arguments[i]);for(e&&null!=e.children&&(u.length||u.push(e.children),delete e.children);u.length;)if((r=u.pop())&&void 0!==r.pop)for(i=r.length;i--;)u.push(r[i]);else"boolean"==typeof r&&(r=null),(o="function"!=typeof t)&&(null==r?r="":"number"==typeof r?r=String(r):"string"!=typeof r&&(o=!1)),o&&n?a[a.length-1]+=r:a===l?a=[r]:a.push(r),n=o;var c=new s;return c.nodeName=t,c.children=a,c.attributes=null==e?void 0:e,c.key=null==e?void 0:e.key,c}function k(t,e){for(var n in e)t[n]=e[n];return t}function p(t,e){t&&("function"==typeof t?t(e):t.current=e)}var n="function"==typeof Promise?Promise.resolve().then.bind(Promise.resolve()):setTimeout,g=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,o=[];function a(t){!t._dirty&&(t._dirty=!0)&&1==o.push(t)&&n(c)}function c(){for(var t;t=o.pop();)t._dirty&&H(t)}function S(t,e){return t.normalizedNodeName===e||t.nodeName.toLowerCase()===e.toLowerCase()}function A(t){var e=k({},t.attributes);e.children=t.children;var n=t.nodeName.defaultProps;if(void 0!==n)for(var r in n)void 0===e[r]&&(e[r]=n[r]);return e}function P(t){var e=t.parentNode;e&&e.removeChild(t)}function m(t,e,n,r,o){if("className"===e&&(e="class"),"key"===e);else if("ref"===e)p(n,null),p(r,t);else if("class"!==e||o)if("style"===e){if(r&&"string"!=typeof r&&"string"!=typeof n||(t.style.cssText=r||""),r&&"object"==typeof r){if("string"!=typeof n)for(var i in n)i in r||(t.style[i]="");for(var i in r)t.style[i]="number"==typeof r[i]&&!1===g.test(i)?r[i]+"px":r[i]}}else if("dangerouslySetInnerHTML"===e)r&&(t.innerHTML=r.__html||"");else if("o"==e[0]&&"n"==e[1]){var a=e!==(e=e.replace(/Capture$/,""));e=e.toLowerCase().substring(2),r?n||t.addEventListener(e,y,a):t.removeEventListener(e,y,a),(t._listeners||(t._listeners={}))[e]=r}else if("list"!==e&&"type"!==e&&!o&&e in t){try{t[e]=null==r?"":r}catch(t){}null!=r&&!1!==r||"spellcheck"==e||t.removeAttribute(e)}else{var c=o&&e!==(e=e.replace(/^xlink:?/,""));null==r||!1===r?c?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.removeAttribute(e):"function"!=typeof r&&(c?t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),r):t.setAttribute(e,r))}else t.className=r||""}function y(t){return this._listeners[t.type](t)}var T=[],E=0,L=!1,O=!1;function F(){for(var t;t=T.shift();)t.componentDidMount&&t.componentDidMount()}function N(t,e,n,r,o){var i=t,a=L;if(null!=e&&"boolean"!=typeof e||(e=""),"string"==typeof e||"number"==typeof e)return t&&void 0!==t.splitText&&t.parentNode&&(!t._component||o)?t.nodeValue!=e&&(t.nodeValue=e):(i=document.createTextNode(e),t&&(t.parentNode&&t.parentNode.replaceChild(i,t),D(t,!0))),i.__preactattr_=!0,i;var c=e.nodeName;if("function"==typeof c)return function(t,e,n,r){var o=t&&t._component,i=o,a=t,c=o&&t._componentConstructor===e.nodeName,s=c,u=A(e);for(;o&&!s&&(o=o._parentComponent);)s=o.constructor===e.nodeName;o&&s&&(!r||o._component)?(M(o,u,3,n,r),t=o.base):(i&&!c&&(B(i),t=a=null),o=U(e.nodeName,u,n),t&&!o.nextBase&&(o.nextBase=t,a=null),M(o,u,1,n,r),t=o.base,a&&t!==a&&(a._component=null,D(a,!1)));return t}(t,e,n,r);if(L="svg"===c||"foreignObject"!==c&&L,c=String(c),(!t||!S(t,c))&&(i=function(t,e){var n=e?document.createElementNS("http://www.w3.org/2000/svg",t):document.createElement(t);return n.normalizedNodeName=t,n}(c,L),t)){for(;t.firstChild;)i.appendChild(t.firstChild);t.parentNode&&t.parentNode.replaceChild(i,t),D(t,!0)}var s=i.firstChild,u=i.__preactattr_,d=e.children;if(null==u){u=i.__preactattr_={};for(var l=i.attributes,p=l.length;p--;)u[l[p].name]=l[p].value}return!O&&d&&1===d.length&&"string"==typeof d[0]&&null!=s&&void 0!==s.splitText&&null==s.nextSibling?s.nodeValue!=d[0]&&(s.nodeValue=d[0]):(d&&d.length||null!=s)&&function(t,e,n,r,o){var i,a,c,s,u,d=t.childNodes,l=[],p={},g=0,m=0,f=d.length,h=0,v=e?e.length:0;if(0!==f)for(var y=0;y<f;y++){var b=d[y],I=b.__preactattr_;null!=(C=v&&I?b._component?b._component.__key:I.key:null)?(g++,p[C]=b):(I||(void 0!==b.splitText?!o||b.nodeValue.trim():o))&&(l[h++]=b)}if(0!==v)for(y=0;y<v;y++){var C;if(s=e[y],(u=null)!=(C=s.key))g&&void 0!==p[C]&&(u=p[C],p[C]=void 0,g--);else if(m<h)for(i=m;i<h;i++)if(void 0!==l[i]&&(w=a=l[i],x=o,"string"==typeof(_=s)||"number"==typeof _?void 0!==w.splitText:"string"==typeof _.nodeName?!w._componentConstructor&&S(w,_.nodeName):x||w._componentConstructor===_.nodeName)){u=a,l[i]=void 0,i===h-1&&h--,i===m&&m++;break}u=N(u,s,n,r),c=d[y],u&&u!==t&&u!==c&&(null==c?t.appendChild(u):u===c.nextSibling?P(c):t.insertBefore(u,c))}var w,_,x;if(g)for(var y in p)void 0!==p[y]&&D(p[y],!1);for(;m<=h;)void 0!==(u=l[h--])&&D(u,!1)}(i,d,n,r,O||null!=u.dangerouslySetInnerHTML),function(t,e,n){var r;for(r in n)e&&null!=e[r]||null==n[r]||m(t,r,n[r],n[r]=void 0,L);for(r in e)"children"===r||"innerHTML"===r||r in n&&e[r]===("value"===r||"checked"===r?t[r]:n[r])||m(t,r,n[r],n[r]=e[r],L)}(i,e.attributes,u),L=a,i}function D(t,e){var n=t._component;n?B(n):(null!=t.__preactattr_&&p(t.__preactattr_.ref,null),!1!==e&&null!=t.__preactattr_||P(t),b(t))}function b(t){for(t=t.lastChild;t;){var e=t.previousSibling;D(t,!0),t=e}}var I=[];function U(t,e,n){var r,o=I.length;for(t.prototype&&t.prototype.render?(r=new t(e,n),w.call(r,e,n)):((r=new w(e,n)).constructor=t,r.render=C);o--;)if(I[o].constructor===t)return r.nextBase=I[o].nextBase,I.splice(o,1),r;return r}function C(t,e,n){return this.constructor(t,n)}function M(t,e,n,r,o){t._disable||(t._disable=!0,t.__ref=e.ref,t.__key=e.key,delete e.ref,delete e.key,void 0===t.constructor.getDerivedStateFromProps&&(!t.base||o?t.componentWillMount&&t.componentWillMount():t.componentWillReceiveProps&&t.componentWillReceiveProps(e,r)),r&&r!==t.context&&(t.prevContext||(t.prevContext=t.context),t.context=r),t.prevProps||(t.prevProps=t.props),t.props=e,t._disable=!1,0!==n&&(1!==n&&!1===i.syncComponentUpdates&&t.base?a(t):H(t,1,o)),p(t.__ref,t))}function H(t,e,n,r){if(!t._disable){var o,i,a,c=t.props,s=t.state,u=t.context,d=t.prevProps||c,l=t.prevState||s,p=t.prevContext||u,g=t.base,m=t.nextBase,f=g||m,h=t._component,v=!1,y=p;if(t.constructor.getDerivedStateFromProps&&(s=k(k({},s),t.constructor.getDerivedStateFromProps(c,s)),t.state=s),g&&(t.props=d,t.state=l,t.context=p,2!==e&&t.shouldComponentUpdate&&!1===t.shouldComponentUpdate(c,s,u)?v=!0:t.componentWillUpdate&&t.componentWillUpdate(c,s,u),t.props=c,t.state=s,t.context=u),t.prevProps=t.prevState=t.prevContext=t.nextBase=null,t._dirty=!1,!v){o=t.render(c,s,u),t.getChildContext&&(u=k(k({},u),t.getChildContext())),g&&t.getSnapshotBeforeUpdate&&(y=t.getSnapshotBeforeUpdate(d,l));var b,I,C=o&&o.nodeName;if("function"==typeof C){var w=A(o);(i=h)&&i.constructor===C&&w.key==i.__key?M(i,w,1,u,!1):(b=i,t._component=i=U(C,w,u),i.nextBase=i.nextBase||m,i._parentComponent=t,M(i,w,0,u,!1),H(i,1,n,!0)),I=i.base}else a=f,(b=h)&&(a=t._component=null),!f&&1!==e||(a&&(a._component=null),I=function(t,e,n,r,o,i){E++||(L=null!=o&&void 0!==o.ownerSVGElement,O=null!=t&&!("__preactattr_"in t));var a=N(t,e,n,r,i);return o&&a.parentNode!==o&&o.appendChild(a),--E||(O=!1,i||F()),a}(a,o,u,n||!g,f&&f.parentNode,!0));if(f&&I!==f&&i!==h){var _=f.parentNode;_&&I!==_&&(_.replaceChild(I,f),b||(f._component=null,D(f,!1)))}if(b&&B(b),(t.base=I)&&!r){for(var x=t,S=t;S=S._parentComponent;)(x=S).base=I;I._component=x,I._componentConstructor=x.constructor}}for(!g||n?T.push(t):v||t.componentDidUpdate&&t.componentDidUpdate(d,l,y);t._renderCallbacks.length;)t._renderCallbacks.pop().call(t);E||r||F()}}function B(t){var e=t.base;t._disable=!0,t.componentWillUnmount&&t.componentWillUnmount(),t.base=null;var n=t._component;n?B(n):e&&(null!=e.__preactattr_&&p(e.__preactattr_.ref,null),P(t.nextBase=e),I.push(t),b(e)),p(t.__ref,null)}function w(t,e){this._dirty=!0,this.context=e,this.props=t,this.state=this.state||{},this._renderCallbacks=[]}k(w.prototype,{setState:function(t,e){this.prevState||(this.prevState=this.state),this.state=k(k({},this.state),"function"==typeof t?t(this.state,this.props):t),e&&this._renderCallbacks.push(e),a(this)},forceUpdate:function(t){t&&this._renderCallbacks.push(t),H(this,2)},render:function(){}});var _=Array.isArray;function x(t){var e,n,r,o="",i=typeof t;if("string"==i||"number"==i)return t||"";if(_(t)&&0<t.length)for(e=0,n=t.length;e<n;e++)""!==(r=x(t[e]))&&(o+=(o&&" ")+r);else for(e in t)t.hasOwnProperty(e)&&t[e]&&(o+=(o&&" ")+e);return o}function R(t,e){var n=["input","select","textarea","button","object","a[href]",'[tabindex="0"]'];e&&n.push('[tabindex="-1"]');for(var r,o,i,a=t.querySelectorAll(n.map(function(t){return t+":not([disabled])"}).join(",")),c=[],s=0;s<a.length;s++){var u=a[s];void 0,o=(r=u).getClientRects(),i=getComputedStyle(r),(0<r.offsetWidth||0<r.offsetHeight||0<o.length)&&"hidden"!==i.visibility&&"none"!==i.display&&0<(i.opacity?parseFloat(i.opacity):1)&&c.push(u)}return c}function W(t,e){return t&&!0!==e(t)?W(t.parentNode||void 0,e):t}var z=["left","top","right","bottom"];function K(i,a,c,s,u,d){return void 0===d&&(d=!1),new f.Promise(function(o){h.delayUntilAnimationFrame(function(){var t;t=u?h.getClientRect(u,-10):function(t){var e=!1;return W(t,function(t){return!h.isElement(t)||("fixed"===getComputedStyle(t).position?e=!0:t===document.documentElement)}),e}(i)?h.getVisibleWindowRect():h.getDocumentRect();var e=function(t){var e=h.getClientRect(t);t&&(e={left:e.left,right:e.left+t.scrollWidth,top:e.top,bottom:e.top+t.scrollHeight,width:t.scrollWidth,height:t.scrollHeight});return e}(i),n=h.getClientRect(a);if(0!==e.height&&0!==e.width){if(f.ME.Loc.rtl||"rtl"===document.dir)switch(c){case"left":c="right";break;case"right":c="left";break;default:s="start"===s?"end":"start"}var r=function(t,e,n,r,o,i){var a,c=r,s=z.indexOf(r),u=-1/0;do{var d=j(t,e,n,c);if(0<=d){a=c;break}u<d&&(u=d,a=c),s=(s+1)%z.length,c=z[s]}while(c!==r);return function(t,e,n,r,o,i){var a=0,c=0,s=0;switch(r){case"left":a=e.left-t.width,c="start"===o?e.top:e.bottom-t.height;break;case"top":a="start"===o?e.left:e.right-t.width,c=e.top-t.height;break;case"right":a=e.right,c="start"===o?e.top:e.bottom-t.height;break;case"bottom":a="start"===o?e.left:e.right-t.width,c=e.bottom}a<n.left?a=n.left:a+t.width>n.right&&(a=n.right-t.width);if(c<n.top){c=n.top,s=c+t.height;var u="top"!==r||i?n.bottom:e.top;u<s&&(s=u)}else if(c+t.height>n.bottom){s=n.bottom,c=s-t.height;var d="bottom"!==r||i?n.top:e.bottom;c<d&&(c=d)}else s=c+t.height;return{left:a,right:a+t.width,width:t.width,top:c,bottom:s,height:s-c}}(t,e,n,a||r,o,i)}(e,n,t,c,s,d);!function(e,t,n){if(e){var r=void 0;"fixed"!==getComputedStyle(e).position&&(r=W(e,function(t){return t!==e&&t!==document&&"static"!==getComputedStyle(t).position})||document.documentElement||void 0);var o=h.getClientRect(r);e.style.left=t.left-o.left+"px",e.style.top=t.top-o.top+"px",e.style.right="auto",e.style.bottom="auto",n?(e.style.height=t.height+"px",e.style.overflow="auto"):e.style.height=e.style.overflow=""}}(i,r,e.height!=r.height)}o()})})}function j(t,e,n,r){var o=function(t,e,n){switch(n){case"top":return{width:e.width,height:t.top-e.top};case"right":return{width:e.right-t.right,height:e.height};case"bottom":return{width:e.width,height:e.bottom-t.bottom};case"left":return{width:t.left-e.left,height:e.height}}}(e,n,r);return t.width<=o.width?o.height-t.height:-1/0}function V(){var t=document.querySelector(".mectrl_body");return t||void 0}var J,q="fixed-menu",G=(e(X,J=w),X.prototype.toggleMenu=function(t){var e=this;void 0===t&&(t=!this.state.expanded),t?(this.menu&&this.trigger&&K(this.menu,this.trigger,this.props.position||"bottom",this.props.alignment||"start",V(),!0).then(function(){document.addEventListener("click",e.expandedClickHandler,!0),document.addEventListener("scroll",e.scrollHandler,!0),window.addEventListener("resize",e.expandedResizeHandler),e.setState({expanded:!0})}),f.logTelemetryEvent({eventType:"PageAction",isCritical:!1,content:{id:this.props.contentId||this.props.id,slot:this.props.contentSlot,source:"Action"}})):(document.removeEventListener("click",this.expandedClickHandler,!0),document.removeEventListener("scroll",this.scrollHandler,!0),window.removeEventListener("resize",this.expandedResizeHandler),this.setState({expanded:!1}))},X.prototype.moveFocus=function(t){if(this.state.expanded&&this.menu){var e=R(this.menu,!0),n=e.length;if(0<n){switch(t){case 0:this.focusIndex=(this.focusIndex+1)%n;break;case 1:this.focusIndex=(this.focusIndex-1+n)%n;break;case 2:this.focusIndex=0;break;case 3:this.focusIndex=n-1}e[this.focusIndex].focus()}}},X.prototype.expandedClickHandler=function(e){if(this.menuRoot&&this.menuRoot.contains(e.target))this.menu&&R(this.menu,!0).some(function(t){return t.contains(e.target)})&&this.toggleMenu(!1);else{this.toggleMenu(!1);var t=V();t&&t.contains(e.target)&&(e.preventDefault(),e.stopPropagation())}},X.prototype.expandedScrollHandler=function(t){this.menuRoot&&t.target&&this.menuRoot.contains(t.target)||this.toggleMenu(!1)},X.prototype.expandedResizeHandler=function(){this.toggleMenu(!1)},X.prototype.menuButtonKeyboardHandler=function(t){var e=!(this.focusAtStart=!0);switch(t.key){case"Up":case"ArrowUp":this.focusAtStart=!1,this.toggleMenu(!0);break;case"Down":case"ArrowDown":this.toggleMenu(!0);break;default:e=!0}e||(t.preventDefault(),t.stopPropagation())},X.prototype.menuItemKeyboardHandler=function(t){var e=!1;switch(t.key){case"Esc":case"Escape":this.toggleMenu(!1);break;case"Up":case"ArrowUp":this.moveFocus(1);break;case"Down":case"ArrowDown":this.moveFocus(0);break;case"Home":this.moveFocus(2);break;case"End":this.moveFocus(3);break;case"Tab":this.toggleMenu(!1);default:e=!0}e||(t.preventDefault(),t.stopPropagation())},X.prototype.componentDidUpdate=function(t,e){var n=this.state.expanded;e.expanded!==n&&(n?this.moveFocus(this.focusAtStart?2:3):this.trigger&&this.trigger.focus())},X.prototype.render=function(){var e=this,t=this.props,n=t.id,r=t.trigger,o=t.items,i=t.cssClass,a=this.state.expanded,c=f.createId(n,"trigger"),s=f.createId(n,"menu"),u=v("button",{id:c,type:"button",class:x(["mectrl_resetStyle",r.cssClass,{expanded:a}]),onClick:function(){return e.toggleMenu()},"aria-label":r.ariaLabel,"aria-haspopup":"true","aria-controls":s,"aria-expanded":a.toString(),"data-noClose":"true",tabIndex:a?-1:0,ref:function(t){return e.trigger=t},onKeyDown:this.menuButtonKeyboardHandler},r.children);return r.ariaLabel&&r.tooltip&&(u=v(h.Tooltip,{text:r.ariaLabel},u)),v("div",{class:x(["mectrl_menu",i]),ref:function(t){return e.menuRoot=t}},u,v("ul",{id:s,role:"menu","aria-labelledby":c,class:a?"expanded":"",ref:function(t){return e.menu=t},onKeyDown:this.menuItemKeyboardHandler},o.map(function(t,e){return v("li",{key:t.key,role:"none"},v(h.LinkButton,d({},t,{tabIndex:-1,role:"menuitem","aria-posinset":e+1,"aria-setsize":o.length})))})))},X);function X(t){var e=J.call(this,t)||this;return e.focusIndex=-1,e.focusAtStart=!0,e.expandedClickHandler=e.expandedClickHandler.bind(e),e.expandedResizeHandler=e.expandedResizeHandler.bind(e),e.menuButtonKeyboardHandler=e.menuButtonKeyboardHandler.bind(e),e.menuItemKeyboardHandler=e.menuItemKeyboardHandler.bind(e),e.scrollHandler=h.debounce(e.expandedScrollHandler.bind(e)),e.state={expanded:!1},e}function Q(t,e,n){var r=new f.SyntheticEvent("commandclick",{commandId:e.id,currentAccount:n}),o=f.getOptions();o&&(o.syntheticEventTarget.dispatchEvent(r)||t.preventDefault()),e.onClick&&(e.onClick(r),r.defaultPrevented&&t.preventDefault())}function $(n){if(!n.commands||0===n.commands.length)return v("div",null);function r(t){return function(){return"function"==typeof t.url?t.url({currentAccount:n.currentAccount,commandId:t.id}):t.url}}var e=n.commands[0],t=n.commands.slice(1),o=t.map(function(e,t){return{id:f.createId(e.id),contentId:"Custom Command",contentSlot:t+1,key:e.id,getUrl:r(e),onClick:function(t){return Q(t,e,n.currentAccount)},ariaLabel:e.ariaLabel,children:[e.text],openInNewTab:e.openInNewTab}}),i=f.getString("morecustomlinks");return v("div",{class:"mectrl_commands"},v(h.LinkButton,{id:f.createId(e.id),contentId:"Custom Command",contentSlot:0,getUrl:r(e),onClick:function(t){return Q(t,e,n.currentAccount)},cssClass:"mectrl_link",ariaLabel:e.ariaLabel,openInNewTab:e.openInNewTab},e.text),0<t.length?v(G,{id:f.createId("moreCommands"),contentId:"Custom Command Menu",trigger:{children:[v("div",{class:"mectrl_glyph glyph_more"})],cssClass:"mectrl_trigger",ariaLabel:i,tooltip:!0},items:o,cssClass:"moreCommands",position:"left"}):null)}function Y(e){return{setPresenceToPartner:function(t){e(h.setPresenceToPartner(t))}}}function Z(t){var e=h.getFullDisplayName(t.account);if(""!==e)return v(h.TruncateText,{id:t.id,cssClass:"mectrl_name",text:e,ariaLabel:e,hideTooltip:!1,showToolTipOnClick:!0});if("aad"==t.account.type)return null;var n="https://account.microsoft.com/profile/edit-name?ref=MeControl";return v(h.LinkButton,{id:f.createId("addName"),contentId:"Add Name",getUrl:function(){return n},onClick:function(t){return h.raiseSyntheticEvent("uriClickEvent",{uri:n},t)},cssClass:"mectrl_link",ariaLabel:f.getString("addyournamelabel"),openInNewTab:!0},f.getString("addyourname"))}function tt(t){var e,n=t.account,r=f.createId("viewAccount"),o=f.createId(r,"desc"),i="",a="";switch(n.type){case"msa":case"msaFed":e=h.setQueryParams(f.ME.Config.msaUrl,{ref:"MeControl",username:n.memberName}),i=f.getString("viewaccount"),a=f.getString("msaaccountlinka11y");break;case"aad":var c={ref:"MeControl",login_hint:n.memberName};n.tenantId&&(c.tid=n.tenantId),e=h.setQueryParams(f.ME.Config.aadUrl,c),i=f.getString("viewaccountaad"),a=f.getString("aadaccountlinka11y")}return v("div",null,v(h.LinkButton,{id:r,contentId:"View Account",getUrl:function(){return e},onClick:function(t){return h.raiseSyntheticEvent("uriClickEvent",{uri:e},t)},cssClass:"mectrl_link","aria-describedby":o,openInNewTab:!0},i),v("span",{id:o,style:"display: none;"},a))}function et(t){var e=t.account,n=f.createId("signedInTitle"),r="mectrl_company";return h.isFunctionallyMsaLike(e)?v("div",{class:r},v("div",{class:"mectrl_glyph glyph_msft",style:{width:"80px"},role:"text","aria-label":"logo"},v("div",{class:"glyph_text"},f.getString("microsoft")))):e.orgName?v(h.TruncateText,{id:n,cssClass:r,text:e.orgName}):null}function nt(t){var e=t.currentAccount,n=t.authProvider,r=t.signOutFromApp,o=t.commands,i=f.createId(st,"picture");return v("div",{class:"mectrl_currentAccount"},v(et,{account:e}),v("div",{class:"mectrl_accountInfo"},v(at,d({},{currentAccount:e,mainIdPart:st,pictureId:i})),v("div",{class:"mectrl_accountDetails"},v(Z,{id:f.createId(st,"primary"),account:e}),v(h.TruncateText,{id:f.createId(st,"secondary"),text:e.memberName}),v(ct,{id:"mectrl_presenceDropdown"}),v(tt,{account:e}),v($,d({},{currentAccount:e,commands:o})))),v(h.LinkButton,{id:f.createId("body","signOut"),contentId:"Sign Out",cssClass:"mectrl_signout",getUrl:function(){if(n.navProvider)return n.navProvider.getSignOutFromAppUrl({currentAccount:e})},ariaLabel:f.getString("signouta11y"),role:"button",onClick:function(t){return r({currentAccount:e},t)}},f.getString("signout")))}function rt(t){var e=t.id,n=t.friendlyName,r=t.details,o=t.isHighlighted,i=void 0!==o&&o;return v("div",{class:"mectrl_accountItemInfo"},v(h.TruncateText,{id:f.createId(e,"primary"),text:n,cssClass:x({signedIn:i})}),r&&n!=r?v(h.TruncateText,{id:f.createId(e,"secondary"),text:r}):null)}function ot(t){return v(G,{id:t.id,contentId:"Remembered Account Actions",contentSlot:t.index,trigger:{children:[v("div",{class:"mectrl_glyph glyph_more"})],cssClass:"mectrl_trigger",ariaLabel:t.triggerAriaLabel,tooltip:!0},items:t.items,cssClass:"mectrl_accountActions",position:"left"})}function it(r){var t=r.index,o=r.account,i=r.authProvider,e=r.hasActiveAccount,n=r.onItemClick,a=r.getItemUrl,c="Loading"===o.accountItemStatus,s=h.getVerbalFriendlyName(o);function u(e){var n=i.navProvider;if(i.isOperationSupported(e,o.type)){return{id:f.createId(gt,t,e),contentId:lt[o.authenticatedState][e],contentSlot:t,key:e,isDisabled:c,getUrl:function(){var t=pt[e];return"getSignOutFromAppUrl"===t?n&&n[t]&&n[t]({currentAccount:o}):n&&n[t]&&n[t]({account:o})},onClick:function(t,e){"Loading"!==o.accountItemStatus?"signOutFromApp"===t?r[t]({currentAccount:o},e):r[t]({account:o},e):e.preventDefault()}.bind(null,e),children:[f.getString(ut[o.authenticatedState][e])],ariaLabel:h.format(f.getString(dt[o.authenticatedState][e]),h.getVerbalFriendlyName(o))}}}var d=c?[]:h.isAadLike(o)&&o.isWindowsSso?[]:("signedIn"===o.authenticatedState?[u("signOutFromApp")]:"signedInIDPOnly"===o.authenticatedState?[u("signOutFromIdp"),u("signOutAndForgetFromIdp")]:[u("signOutAndForgetFromIdp")]).filter(Boolean);return v("div",{class:"mectrl_accountItem"},v(h.LinkButton,{id:f.createId(gt,t,"switch"),contentId:"Remembered Account Switch",contentType:o.type,contentSlot:t,isDisabled:c,getUrl:function(){return a(o)},onClick:function(t){return n(o,t)},cssClass:x(["primaryAction",e?"switchTo":"signInTo"]),ariaLabel:function(t){var e=h.getVerbalFriendlyName(t),n=h.format(f.getString("switchaccounta11yformat1"),e);switch(t.accountItemStatus){case"Normal":return n;case"Loading":case"Error":var r=n[n.length-1];n+="."===r?"":".";var o=h.format(f.getString("accountstatusa11yformat1"),mt(t));return n+" "+o}}(o)},v(h.ProfilePicture,{id:f.createId(gt,t,"picture"),currentAccount:o}),v(rt,{id:f.createId(gt,t),friendlyName:h.getAccountListDisplayName(o),details:mt(o),isHighlighted:h.isSignedIn(o)})),0<d.length?v(ot,{id:f.createId(gt,t,"actions"),index:t,items:d,triggerAriaLabel:h.format(f.getString("signoutmenua11yformat1"),s)}):null)}var at=h.connect(function(t){return{currentPresence:t.presenceConfig.currentPresence}},function(){})(function(t){var e=t.currentAccount,n=t.currentPresence,r={},o=h.isFunctionallyMsaOrWithEditPicUrl(e)&&t.pictureId?v(h.ProfilePictureOverlay,d({id:t.pictureId},t)):v("div",{id:t.pictureId},v(h.ProfilePicture,d({},t)));return t.mainIdPart&&n&&(r.backgroundImage="url("+n.imageUrl+")",o=v("div",{class:"mectrl_presence_container"},v("div",{class:"mectrl_presence",style:r}),o)),o}),ct=h.connect(function(t){return{presenceConfig:t.presenceConfig}},Y)(function(n){var t=null,e=n.id,r=n.presenceConfig;if(r&&r.currentPresence&&r.presenceList){var o=r.presenceList.map(function(t,e){return{id:f.createId(t.presenceString),contentId:"Presence State Change",contentSlot:e,key:t.presenceString,getUrl:void 0,onClick:function(){n.setPresenceToPartner&&n.setPresenceToPartner(t)},ariaLabel:t.presenceString,children:[v("div",{class:"mectrl_presence_indicator_container"},v("div",{style:{backgroundImage:"url("+t.imageUrl+")"}})),v("div",{class:"mectrl_presence_string_container"},t.presenceString)],openInNewTab:!1,"data-noClose":"true"}}),i=r.currentPresence.presenceString;t=v(G,{id:e,contentId:"Presence Dropdown",trigger:{children:[v("div",{class:"mectrl_presence_dropdown_text"},i),v("div",{class:"mectrl_presence_dropdown_glyph glyph_chevron"})],cssClass:"mectrl_trigger",ariaLabel:i},items:o,cssClass:"presenceDropdown",position:"bottom"})}return t}),st="currentAccount",ut={signedIn:{signOutFromApp:"signout"},signedInIDPOnly:{signOutFromIdp:"signout",signOutAndForgetFromIdp:"signoutandforget"},notSignedIn:{signOutAndForgetFromIdp:"forget"}},dt={signedIn:{signOutFromApp:"signoutaccounta11yformat1"},signedInIDPOnly:{signOutFromIdp:"signoutaccounta11yformat1",signOutAndForgetFromIdp:"signoutandforgetaccounta11yformat1"},notSignedIn:{signOutAndForgetFromIdp:"forgetaccounta11yformat1"}},lt={signedIn:{signOutFromApp:"Sign Out"},signedInIDPOnly:{signOutFromIdp:"Remembered Account Sign Out",signOutAndForgetFromIdp:"Remembered Account Sign Out and Forget"},notSignedIn:{signOutAndForgetFromIdp:"Remembered Account Forget"}},pt={signOutFromApp:"getSignOutFromAppUrl",signOutFromIdp:"getSignOutFromIdpUrl",signOutAndForgetFromIdp:"getSignOutAndForgetFromIdpUrl"},gt="rememberedAccount";function mt(t){switch(t.accountItemStatus){case"Normal":return t.memberName;case"Loading":return f.getString("signoutloading");case"Error":return f.getString("signouterror")}}function ft(t){return 6===t.authProvider.supportedSignInAccountTypes?v(yt,d({},t)):v(bt,d({},t))}var ht="signInItem",vt="primaryAction signIn",yt=function(t){function e(e){return{id:f.createId(ht,e.index),key:e.key,contentId:"Sign In Another Account",contentSlot:e.index,getUrl:function(){return r(e.signInType)},onClick:function(t){return n(e.signInType,t)},children:[e.text]}}var n=t.signInClick,r=t.getSignInUrl;return v(G,{id:f.createId(ht),contentId:"Sign In Account Menu",trigger:{children:It(),cssClass:vt,ariaLabel:f.getString("signinaddaccounta11y")},items:[e({index:0,key:"signInWithMSAItem",text:f.getString("signinwithmsaaccount"),signInType:2}),e({index:1,key:"signInWithAADItem",text:f.getString("signinwithaadaccount"),signInType:4})],cssClass:x(["mectrl_accountItem",q]),position:"top",alignment:"end"})},bt=function(t){var e=t.authProvider,n=t.signInClick,r=t.getSignInUrl;return v("div",{class:"mectrl_accountItem"},v(h.LinkButton,{id:f.createId(ht),contentId:"Sign In Another Account",getUrl:function(){return r(e.supportedSignInAccountTypes)},onClick:function(t){return n(e.supportedSignInAccountTypes,t)},cssClass:vt,ariaLabel:f.getString("signinwithdifferentaccount")},It()))};function It(){return[v(h.ProfilePicture,{id:f.createId(ht,"picture"),glyphClassOverride:"mectrl_signIn_circle_glyph"}),v("div",{class:"mectrl_accountItemInfo"},v(h.TruncateText,{text:f.getString("signinwithdifferentaccount")}))]}function Ct(t){return v("div",{class:"mectrl_scrollShadow "+t.cssClass},h.toChildArray(t.children)[0])}function wt(n){function r(t,e){p?a({currentAccount:p,nextAccount:t},e):c({nextAccount:t},e)}function o(t){if(i.navProvider)return p?i.navProvider.getSwitchToUrl({currentAccount:p,nextAccount:t}):i.navProvider.getSignInToUrl({nextAccount:t})}var t=n.accounts,i=n.authProvider,a=n.switchTo,c=n.signInTo,s=n.signIn,u=n.signOutFromApp,d=n.signOutFromIdp,l=n.signOutAndForgetFromIdp,e=h.getOtherAccounts(t),p=h.getCurrentAccount(t),g=void 0!==p,m=e.filter(function(t){return g&&i.isOperationSupported("switchTo",t.type)||!g&&i.isOperationSupported("signInTo",t.type)}).sort(_t).map(function(t,e){return v("li",{key:h.getAccountId(t)},v(it,{index:e,account:t,hasActiveAccount:g,authProvider:i,onItemClick:r,getItemUrl:o,signOutFromApp:u,signOutFromIdp:d,signOutAndForgetFromIdp:l}))});return g&&!function(t,e){return t.isOperationSupported(e,"msa")||t.isOperationSupported(e,"aad")||t.isOperationSupported(e,"msaFed")}(i,"switch")||m.push(v("li",null,v(ft,{authProvider:i,signInClick:function(t,e){g?n.switch({currentAccount:p,signInType:t},e):s({signInType:t},e)},getSignInUrl:function(t){if(i.navProvider)return g?i.navProvider.getSwitchUrl({currentAccount:p,signInType:t}):i.navProvider.getSignInUrl({signInType:t})}}))),v(Ct,{cssClass:x(["mectrl_accountList_container",{signedOut:!g}])},v("ul",{"aria-label":g?void 0:f.getString("chooseanaccount"),class:"mectrl_accountList"},m))}function _t(t,e){if(t.authenticatedState!==e.authenticatedState)return"signedIn"===t.authenticatedState?-1:"notSignedIn"===t.authenticatedState?1:"signedIn"===e.authenticatedState?1:-1;var n=t.memberName.toLowerCase(),r=e.memberName.toLowerCase();return n<r?-1:r<n?1:0}function xt(){return v("h1",{id:f.createId("signInTitle"),class:"mectrl_signedOutAccountListHeader"},f.getString("chooseanaccount"))}var St,kt=(e(At,St=w),At.prototype.setUpFocusTraps=function(){var t=this;if(this.body&&this.trigger){var e=R(this.body);if(0<e.length){var n=this.trigger,r=e[e.length-1],o=this.focusTrap.bind(null,!0,r),i=this.focusTrap.bind(null,!1,n);n.addEventListener("keydown",o),r.addEventListener("keydown",i),this.removeFocusTraps=function(){n.removeEventListener("keydown",o),r.removeEventListener("keydown",i),t.removeFocusTraps=void 0}}}},At.prototype.focusTrap=function(t,e,n){"Tab"===n.key&&n.shiftKey===t&&(n.preventDefault(),n.stopPropagation(),e.focus())},At.prototype.onExpandedClick=function(t){var e=this.trigger&&this.trigger.contains(t.target);this.body&&this.body.contains(t.target)||e||this.toggleDropdown(!1,2)},At.prototype.onInteractiveClick=function(t){var e=this,n=!1;W(t.target,function(t){return function(t){return t.hasAttribute&&!t.hasAttribute("data-noClose")&&!t.hasAttribute("disabled")&&("BUTTON"===t.nodeName||"A"===t.nodeName)}(t)&&(n=!0),e.body&&t===e.body}),n&&this.toggleDropdown(!1,1)},At.prototype.onExpandedKeyDown=function(t){switch(t.key){case"Escape":case"Esc":t.preventDefault(),t.stopPropagation(),this.toggleDropdown(!1,2),this.trigger&&this.trigger.focus()}},At.prototype.onExpandedResize=function(){this.toggleDropdown(!1,2)},At.prototype.toggleDropdown=function(t,e){var n=this;void 0===t&&(t=!this.state.expanded),void 0===e&&(e=0),t?this.body&&this.trigger&&K(this.body,this.trigger,this.props.position||"bottom",this.props.alignment||"start").then(function(){document.addEventListener("click",n.onExpandedClick,!0),window.addEventListener("resize",n.onExpandedResize),n.body&&(n.body.addEventListener("click",n.onInteractiveClick),n.body.addEventListener("keydown",n.onExpandedKeyDown)),n.trigger&&n.trigger.addEventListener("keydown",n.onExpandedKeyDown),n.setState({expanded:!0})}):(document.removeEventListener("click",this.onExpandedClick,!0),window.removeEventListener("resize",this.onExpandedResize),this.body&&(this.body.removeEventListener("click",this.onInteractiveClick),this.body.removeEventListener("keydown",this.onExpandedKeyDown)),this.trigger&&this.trigger.removeEventListener("keydown",this.onExpandedKeyDown),this.setState({expanded:!1})),this.props.onToggle&&this.props.onToggle(t,e)},At.prototype.componentDidMount=function(){!0===this.props.defaultExpanded&&this.toggleDropdown(!0)},At.prototype.componentDidUpdate=function(t,e){var n,r=this.state.expanded;if(this.removeFocusTraps&&this.removeFocusTraps(),r){this.setUpFocusTraps();var o=!e.expanded;this.body&&o&&(null===(n=R(this.body)[0])||void 0===n||n.focus())}var i=!r&&e.expanded,a=document.activeElement,c=null==a||a===document.body;i&&c&&this.trigger&&this.trigger.focus()},At);function At(t){var e=St.call(this,t)||this;return e.state={expanded:!1},e.onExpandedClick=e.onExpandedClick.bind(e),e.onInteractiveClick=e.onInteractiveClick.bind(e),e.onExpandedKeyDown=e.onExpandedKeyDown.bind(e),e.onExpandedResize=e.onExpandedResize.bind(e),e}var Pt,Tt=(e(Et,Pt=kt),Et.prototype.render=function(){var e=this,t=this.props,n=t.id,r=t.renderBody,o=t.renderTrigger,i=t.cssClass,a=t.ariaLabel,c=t.tooltip,s=this.state.expanded,u=f.createId(n,"trigger"),d=f.createId(n,"body"),l=v("button",{id:u,type:"button",class:"mectrl_resetStyle mectrl_trigger",onClick:function(){return e.toggleDropdown()},"aria-label":a,"aria-expanded":s.toString(),"aria-controls":d,"data-noClose":"true",ref:function(t){return e.trigger=t}},o(s));return c&&a&&(l=v(h.Tooltip,{text:a,hideOverride:s},l)),v("div",{class:x(["mectrl_dropdown",i]),role:s?"dialog":void 0,"aria-label":s?a:void 0},l,v("div",{id:d,class:x(["mectrl_dropdownbody",{expanded:s}]),ref:function(t){return e.body=t}},r()))},Et);function Et(t){return Pt.call(this,t)||this}var Lt=h.connect(function(t){return{currentPresence:t.presenceConfig.currentPresence}},function(){})(function(t){var e=t.currentPresence,n={},r=null;return e&&(n.backgroundImage="url("+e.imageUrl+")",r=v("div",{class:"mectrl_presence_header",style:n})),r});function Ot(t){var e=t.map(Nt),n=window.XDomainRequest?new window.XDomainRequest:window.XMLHttpRequest?new window.XMLHttpRequest:null;n&&(n.withCredentials&&(n.withCredentials=!0),n.open("POST",f.vortexEndpoint),n.send(e.join("\n")))}function Ft(){return!0}function Nt(t){return"{"+[f.assign({},t.partA,{ext:void 0}),{data:f.assign({},t.partC,{baseData:t.partB&&f.assign({},t.partB)})},{ext:f.assign({},t.partA.ext)}].map(Dt).join(",")+"}"}function Dt(n){return n?Object.getOwnPropertyNames(n).map(function(t){var e=n[t];switch(typeof e){case"object":return null!==e?'"'+t+'":{'+Dt(e)+"}":null;case"string":e='"'+e.replace(/['"]/g,'\\"')+'"';case"number":case"boolean":return'"'+t+'":'+e}return null}).filter(function(t){return!!t}).join(","):""}function Ut(t){var e=t.map(Nt);navigator.sendBeacon(f.vortexEndpoint,e.join("\n"))||Ot(t)}function Mt(){return!(!navigator||!navigator.sendBeacon)}var Ht="Ms.Webi.ContentUpdate",Bt="Ms.Content.ContentUpdate";function Rt(t,e){var n=f.createPartA(Ht,e.date,e.cv),r=f.getContentJson(t.content);return{partA:n,partB:{ver:"1.0",impressionGuid:e.impressionGuid,market:f.ME.Config.mkt,pageTags:JSON.stringify(f.getPageTags(e.accounts.counts,e.accounts.current)),contentVer:"2.0",content:"["+r+"]"},partC:{baseType:Bt,pageLoadTime:Math.round(t.loadTime),timings:JSON.stringify(t.timings),cookieEnabled:!0===navigator.cookieEnabled,isJs:!0,isLoggedIn:!!e.accounts.current,isManual:!0}}}var Wt="Ms.Webi.PageAction",zt="Ms.Content.PageAction";function Kt(t,e){var n=f.createPartA(Wt,e.date,e.cv),r=f.getContentJson(t.content),o=t.targetUrl&&f.scrubUrl(t.targetUrl);return{partA:n,partB:{ver:"1.1",pageName:e.pageName,impressionGuid:e.impressionGuid,destUri:o,market:f.ME.Config.mkt,pageTags:JSON.stringify(f.getPageTags(e.accounts.counts,e.accounts.current)),contentVer:"2.0",content:"["+r+"]"},partC:{baseType:zt,timeToAction:f.getTimeSince(e.timestamp),cookieEnabled:!0===navigator.cookieEnabled,isJs:!0,isLoggedIn:!!e.accounts.current,isManual:!0}}}var jt="Ms.Webi.MeControl.PartnerApiCall",Vt=["*","!idp","!authenticatedState","!type","!apiGeneration"],Jt=/https?:\/\/.*/i;function qt(t,e){var n=f.createPartA(jt,e.date,e.cv),r=h.filterObject(t.params,Vt);return function t(e){for(var n in e){var r=e[n];switch(typeof r){case"object":null!=r&&t(r);break;case"string":Jt.test(r)&&(e[n]=f.scrubUrl(r))}}}(r),{partA:n,partB:void 0,partC:{baseType:void 0,partner:f.ME.Config.ptn,controlVersion:f.ME.Config.ver,methodName:t.method,parameters:JSON.stringify(r)}}}f.loadCss(f.ME.CssmeCore),t.Body=function(t){var e=t.accounts,n=t.commands,r=t.authProvider,o=t.signOutFromApp,i=h.getCurrentAccount(e),a=[];return i?a.push(v(nt,{currentAccount:i,commands:n,authProvider:r,signOutFromApp:o}),v(wt,d({},t))):a.push(v(xt,null),v(wt,d({},t))),v("div",{class:"mectrl_body"},a)},t.Dropdown=Tt,t.Menu=G,t.Presence=at,t.PresenceDropdown=ct,t.PresenceHeader=Lt,t.enhanceTelemetry=function(t){void 0===t&&(t=!0),t&&(f.addEventWriter(Ot,Ft,7),f.addEventWriter(Ut,Mt,3)),f.batchEvents(t),f.setEventCreator("ContentUpdate",Rt),f.setEventCreator("PageAction",Kt),f.setEventCreator("PartnerApiCall",qt),f.initialize1DS().then(function(){f.flushEvents()}).catch(function(){f.initialize1DS().then(function(){f.flushEvents()})})},t.fixedMenuClass=q,t.mapDispatchToProps=Y,Object.defineProperty(t,"__esModule",{value:!0})});
